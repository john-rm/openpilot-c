...
<h3>
  <a href="https://docs.comma.ai">official openpilot docs</a>
  <span> · </span>
  <a href="https://docs.comma.ai/contributing/roadmap/">official openpilot roadmap</a>
  <span> · </span>
  <a href="https://discord.comma.ai">official comma.ai community</a>
</h3>
...
The `master` branch is supposed to be the stable/default branch, which means that it should successfully compile. All other branches are experimental or testing branches.
